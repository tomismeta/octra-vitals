...
const sourcePath = join(root, "program-history-probe", "main.aml");
const buildDir = join(root, "build", "program-history-probe");
...
const compileArtifact = {
  ...
  source_path: "program-history-probe/main.aml",
...
console.log(stableJson({
  ...
  size: result.size,
  outputs: [
    "build/program-history-probe/compile.json"
  ],
