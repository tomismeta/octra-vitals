...
const sourcePath = join(root, "program-history-probe", "map-calendar.aml");
const buildDir = join(root, "build", "program-history-map-probe");
...
const compileArtifact = {
  ...
  source_path: "program-history-probe/map-calendar.aml",
...
console.log(stableJson({
  ...
  size: result.size,
  outputs: [
    "build/program-history-map-probe/compile.json"
  ],
